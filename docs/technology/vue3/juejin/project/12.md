---
title: 12. Vue3 实战之首页大盘数据
lang: zh-CN
---

![home_data](./images/home_data.png)
...
![home_card](./images/home_card.png)
...
你可以设置折线图、柱状图、饼图、散点图、雷达图、K 线图等等等等。经常写可视化配置的同学，也难免遇到一些配置问题，碰到问题一定要查阅文档。
